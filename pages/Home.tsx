...
const Home: React.FC = () => {
  ...
  return (
    <div className="overflow-hidden bg-[#fcfbf7]">
      ...
      <section className="py-24 sm:py-32 lg:py-40 bg-[#1a2323] relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-white/5 rounded-full -translate-y-1/2 translate-x-1/2 blur-3xl"></div>
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-12">
               <div>
                  <span className="text-[#8b5e3c] text-xs font-bold uppercase tracking-[0.4em] mb-4 block">Purpose & Legacy</span>
                  <h2 className="text-5xl lg:text-7xl font-bold serif text-white leading-tight">Rooted in <br /> Authenticity.</h2>
               </div>
               <div className="space-y-10">
                  <div className="flex gap-8 group">
                    <div className="w-16 h-16 rounded-3xl bg-white/5 border border-white/10 flex items-center justify-center shrink-0 group-hover:bg-[#8b5e3c] transition-all duration-500">
                      <span className="text-2xl">🌱</span>
                    </div>
                    <div>
                      <h4 className="text-xl font-bold serif text-white mb-3">Brand Mission</h4>
                      <p className="text-white/60 leading-relaxed font-light">To deliver pure, wild-harvested mountain products rooted in authenticity, sustainability, and tradition.</p>
                    </div>
                  </div>
                  <div className="flex gap-8 group">
                    <div className="w-16 h-16 rounded-3xl bg-white/5 border border-white/10 flex items-center justify-center shrink-0 group-hover:bg-[#4a5d4e] transition-all duration-500">
                      <span className="text-2xl">🏔️</span>
                    </div>
                    <div>
                      <h4 className="text-xl font-bold serif text-white mb-3">Brand Vision</h4>
                      <p className="text-white/60 leading-relaxed font-light">To become India’s most trusted mountain-origin brand—known for purity, craftsmanship, and ethical sourcing.</p>
                    </div>
                  </div>
               </div>
            </div>
            <div className="relative">
              <div className="aspect-square rounded-[4rem] overflow-hidden border-[15px] border-white/5">
              ...
              <div className="absolute -bottom-10 -left-10 bg-white p-10 rounded-[3rem] shadow-2xl max-w-xs">
                 <p className="text-[10px] uppercase font-bold text-[#8b5e3c] tracking-widest mb-2">Our Promise</p>
                 <p className="font-bold text-[#2d3a3a] leading-relaxed">No mass production. Only heritage crafting in the heart of Himachal.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 sm:py-32 lg:py-40 bg-white rounded-t-[4rem] sm:rounded-t-[6rem] relative z-20">
