  ...
  return (
    <div className="pt-32 lg:pt-44 pb-24 bg-[#fcfbf7] min-h-screen">
      <div className="max-w-4xl mx-auto px-6">
        <h1 className="text-4xl lg:text-5xl font-bold serif mb-10 text-[#2d3a3a]">{title}</h1>
        <div className="bg-white p-10 lg:p-14 rounded-[2.5rem] shadow-sm border border-gray-100 text-gray-600 leading-relaxed space-y-8 text-sm lg:text-base">
          {children}
        </div>
      </div>
    </div>
...
export const PrivacyPolicy: React.FC = () => (
  <LegalContent title="Privacy Policy">
    ...
    <h3 className="text-xl font-bold serif text-[#1a2323]">Data We Collect</h3>
    ...
    <h3 className="text-xl font-bold serif text-[#1a2323]">How We Use Data</h3>
...
export const TermsConditions: React.FC = () => (
  <LegalContent title="Terms & Conditions">
    ...
    <h3 className="text-xl font-bold serif text-[#1a2323]">Product Usage</h3>
    ...
    <h3 className="text-xl font-bold serif text-[#1a2323]">Ordering & Payments</h3>
...
export const ShippingRefund: React.FC = () => (
  <LegalContent title="Shipping & Refund Policy">
    <h3 className="text-xl font-bold serif text-[#1a2323]">Mountain Dispatch</h3>
    ...
    <h3 className="text-xl font-bold serif text-[#1a2323]">Returns & Refunds</h3>
